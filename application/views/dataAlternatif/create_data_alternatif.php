...
<body>
	<div class="container">
		<div class="col-lg-12 mt-3 stretch-card">
			<div class="card">
				<div class="card-body">
					<h5 class="card-title">Input Data Alternatif</h5>
					<?php
					$action_form = '/data/save/';
					?>
					<form class="cmxform" id="form_data_alternatif" method="post" enctype="multipart/form-data" action="<?=site_url($action_form)?>">
						<fieldset>
